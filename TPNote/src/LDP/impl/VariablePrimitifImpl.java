 ...
 * </p>
 * <ul>
 *   <li>{@link LDP.impl.VariablePrimitifImpl#getValeur <em>Valeur</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariablePrimitifImpl extends VariableImpl implements VariablePrimitif {
	...
	protected EClass eStaticClass() {
		return LDPPackage.Literals.VARIABLE_PRIMITIF;
	}
	...
	public void setValeur(String newValeur) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDPPackage.VARIABLE_PRIMITIF__VALEUR, oldValeur, valeur));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDPPackage.VARIABLE_PRIMITIF__VALEUR:
				return getValeur();
		}
