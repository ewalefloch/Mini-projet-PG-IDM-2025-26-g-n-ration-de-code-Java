 ...
 * </p>
 * <ul>
 *   <li>{@link LDP2.impl.MethodImpl#getNomMethode <em>Nom Methode</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MethodImpl extends MinimalEObjectImpl.Container implements Method {
	...
	protected EClass eStaticClass() {
		return LDP2Package.Literals.METHOD;
	}
	...
	public void setNomMethode(String newNomMethode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDP2Package.METHOD__NOM_METHODE, oldNomMethode, nomMethode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDP2Package.METHOD__NOM_METHODE:
