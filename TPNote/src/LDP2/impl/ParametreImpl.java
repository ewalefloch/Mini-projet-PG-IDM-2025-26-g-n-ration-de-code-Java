 ...
 * </p>
 * <ul>
 *   <li>{@link LDP2.impl.ParametreImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParametreImpl extends MinimalEObjectImpl.Container implements Parametre {
	...
	protected EClass eStaticClass() {
		return LDP2Package.Literals.PARAMETRE;
	}
	...
	public EList<Variable> getParameters() {
		if (parameters == null) {
			parameters = new EObjectResolvingEList<Variable>(Variable.class, this, LDP2Package.PARAMETRE__PARAMETERS);
		}
		return parameters;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDP2Package.PARAMETRE__PARAMETERS:
